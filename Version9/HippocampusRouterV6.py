...
class HippocampusRouterV6(nn.Module):
    """
    ...
    def route(self, clip_vec, text=None):
        ...
        with torch.no_grad():
            ...
            if text:
                ...
                identity_patterns = [
                    r"\b我是谁\b", r"\b你是谁\b", r"\b我叫\b", r"\b你叫\b", 
                    r"\b名字\b", r"\b身份\b", r"\b主人\b", r"\b你是\b", r"\b我是\b",
                    r"\b关系\b", r"\b自己\b", r"\b本人\b"
                ]
                # ===================== 最高优先级：身份/人称/主人/名字 =====================
                # 🔥 移除写死的"邓尧"和"小白"，只保留通用关键词
