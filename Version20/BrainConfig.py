...
class BrainConfig(BaseSettings):
    ...
    # 存储配置
    storage_dir: str = "brain_v12_demo"

    YOUR_VAE_MODEL_PATH: str = r'D:\2250111005\HippoCortex\sd-vae-ft-mse'
    ...
    # 🔥 新增：对话记忆全局配置
    CONVERSATION_MEMORY_CONFIG: Dict = {
