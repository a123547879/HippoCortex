...
from AdvancedBrainV5 import AdvancedBrainV5
from LLMBrainWrapperV3 import LLMBrainWrapperV3
...
if __name__ == "__main__":
    ...
    print("🧠 初始化类脑记忆系统...")
    print("=" * 60)
    brain = AdvancedBrainV5(dim=config.dim, storage_dir=config.storage_dir, ollama_model= "bge-m3")

    # 2. 包装 LLM 增强层
    print("\n" + "=" * 60)
    llm_brain = LLMBrainWrapperV3(brain)
    print("=" * 60)
